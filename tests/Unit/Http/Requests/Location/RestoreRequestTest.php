...
/**
 * \Tests\Unit\Playground\Crm\Api\Http\Requests\Location\RestoreRequestTest
 */
class RestoreRequestTest extends RequestTestCase
{
    protected string $requestClass = \Playground\Crm\Api\Http\Requests\Location\RestoreRequest::class;
}
