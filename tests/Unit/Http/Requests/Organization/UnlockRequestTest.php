...
/**
 * \Tests\Unit\Playground\Crm\Api\Http\Requests\Organization\UnlockRequestTest
 */
class UnlockRequestTest extends RequestTestCase
{
    protected string $requestClass = \Playground\Crm\Api\Http\Requests\Organization\UnlockRequest::class;
}
