...
/**
 * \Tests\Unit\Playground\Crm\Api\Http\Requests\Organization\RestoreRequestTest
 */
class RestoreRequestTest extends RequestTestCase
{
    protected string $requestClass = \Playground\Crm\Api\Http\Requests\Organization\RestoreRequest::class;
}
