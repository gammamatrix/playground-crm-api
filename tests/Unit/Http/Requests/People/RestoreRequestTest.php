...
/**
 * \Tests\Unit\Playground\Crm\Api\Http\Requests\People\RestoreRequestTest
 */
class RestoreRequestTest extends RequestTestCase
{
    protected string $requestClass = \Playground\Crm\Api\Http\Requests\People\RestoreRequest::class;
}
