...
/**
 * \Playground\Crm\Api\Http\Requests\People\IndexRequest
 */
class IndexRequest extends BaseIndexRequest
{
    ...
    protected array $paginationIds = [
        ...
        'people_type' => ['column' => 'people_type', 'label' => 'People Type', 'type' => 'string', 'nullable' => true],
    ...
    protected array $sortable = [
        ...
        'people_type' => ['column' => 'people_type', 'label' => 'People Type', 'type' => 'string'],
