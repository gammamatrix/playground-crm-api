...
/**
 * \Playground\Crm\Api\Http\Requests\Organization\IndexRequest
 */
class IndexRequest extends BaseIndexRequest
{
    ...
    protected array $paginationFlags = [
        ...
        'featured' => ['column' => 'featured', 'label' => 'Featured', 'icon' => 'fa-solid fa-star text-primary'],
    ...
    protected array $paginationIds = [
        ...
        'organization_type' => ['column' => 'organization_type', 'label' => 'Organization Type', 'type' => 'string', 'nullable' => true],
        ...
        'client_id' => ['column' => 'client_id', 'label' => 'Client id', 'type' => 'uuid', 'nullable' => true],
        'contact_id' => ['column' => 'contact_id', 'label' => 'Contact id', 'type' => 'uuid', 'nullable' => true],
        'location_id' => ['column' => 'location_id', 'label' => 'Location id', 'type' => 'uuid', 'nullable' => true],
        'people_id' => ['column' => 'people_id', 'label' => 'People id', 'type' => 'uuid', 'nullable' => true],
    ];
    ...
    protected array $sortable = [
        ...
        'organization_type' => ['column' => 'organization_type', 'label' => 'Organization Type', 'type' => 'string'],
        ...
        'client_id' => ['column' => 'client_id', 'label' => 'Client id', 'type' => 'string'],
        'contact_id' => ['column' => 'contact_id', 'label' => 'Contact id', 'type' => 'string'],
        'location_id' => ['column' => 'location_id', 'label' => 'Location id', 'type' => 'string'],
        'people_id' => ['column' => 'people_id', 'label' => 'People id', 'type' => 'string'],
