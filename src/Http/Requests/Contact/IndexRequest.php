...
/**
 * \Playground\Crm\Api\Http\Requests\Contact\IndexRequest
 */
class IndexRequest extends BaseIndexRequest
{
    ...
    protected array $paginationIds = [
        ...
        'contact_type' => ['column' => 'contact_type', 'label' => 'Contact Type', 'type' => 'string', 'nullable' => true],
        ...
        'organization_id' => ['column' => 'organization_id', 'label' => 'Organization id', 'type' => 'uuid', 'nullable' => true],
    ...
    protected array $sortable = [
        ...
        'contact_type' => ['column' => 'contact_type', 'label' => 'Contact Type', 'type' => 'string'],
        ...
        'organization_id' => ['column' => 'organization_id', 'label' => 'Organization id', 'type' => 'string'],
