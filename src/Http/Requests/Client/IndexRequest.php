...
/**
 * \Playground\Crm\Api\Http\Requests\Client\IndexRequest
 */
class IndexRequest extends BaseIndexRequest
{
    ...
    protected array $paginationIds = [
        ...
        'client_type' => ['column' => 'client_type', 'label' => 'Client Type', 'type' => 'string', 'nullable' => true],
    ...
    protected array $sortable = [
        ...
        'client_type' => ['column' => 'client_type', 'label' => 'Client Type', 'type' => 'string'],
