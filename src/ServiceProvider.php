...
class ServiceProvider extends AuthServiceProvider
{
    ...
    public string $package = 'playground-crm-api';
    ...
    public function boot(): void
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            // Publish routes
            $this->publishes([
                dirname(__DIR__).'/routes' => base_path('routes/playground-crm-api'),
            ], 'playground-routes');
        }
    ...
    public function register(): void
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/config/playground-crm-api.php',
            $this->package
        );
    }
    ...
    public function about(): void
    {
        ...
        AboutCommand::add('Playground: CRM API', fn () => [
